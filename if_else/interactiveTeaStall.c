...
int main()
{
    int choice,tea,coffee,coldCoffee,totalPrice,userAmmount,change;
    char yesNo;
    ...
    payAgain:
    printf("\n Enter your payment amount: Rs.",userAmmount);
    scanf("%d",&userAmmount);
    if (userAmmount<totalPrice)
    {
        printf("You are paying less amount than The Bill");
        goto payAgain;
        
    }
    
    change = userAmmount-totalPrice;
    printf("\n Change: Rs. [%d]",change);
